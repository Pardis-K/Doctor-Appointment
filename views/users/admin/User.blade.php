...
<fieldset style="position: absolute; right: 300px; top:200px; width: 400px; border-radius = 10px;border-color:black;">
@csrf
<div class="row">
    <div class="col">
...
<table>
  ...
  @foreach ($users as $user)
    ...
    <td>{{ $user->username }}</td>
    <td>{{ $user->role }}</td>
    <td><a style="text-decoration:none;" href="/User/{{$user->id}}/delete "><i class="fa fa-edit"></i></a>
    <a style="text-decoration:none;" href="/User/{{$user->id}}/editable "><i class="fa fa-close"></i></a></td> 
    @endforeach
  </tr>
</table>
@endsection