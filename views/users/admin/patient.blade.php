...
<table>
  ...
  @foreach ($patients as $patient)
    ...
    <td><a style="text-decoration:none;" href="/Patient/{{$patient->id}}/delete "><i class="fa fa-edit"></i></a>
    <a style="text-decoration:none;" href="/Patient/{{$patient->id}}/editable"><i class="fa fa-close"></i></a></td> 
    </td>
    @endforeach
  </tr>
</table>
