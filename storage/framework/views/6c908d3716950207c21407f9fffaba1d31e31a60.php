...
<ul class="list" id="M">  
  ...
  <li>
    <a class="nav-link" href="<?php echo e(route('Reservee')); ?>">ویزیت بیمار</a>
  </li>
  <li>
    <a class="nav-link" href="<?php echo e(route('Fvisit')); ?>">پنل کاربری</a>
  </li>
  <li>
...
<?php /**PATH C:\Users\Pardis\Documents\Doctorappointmentfixed\resources\views/layouts/doctor.blade.php ENDPATH**/ ?>