...
<table>
  ...
  @foreach ($users as $user)
    ...
    <td>{{ $user->username }}</td>
    <td>{{ $user->role }}</td>
    <td><a style="text-decoration:none;" href="/User/{{$user->id}}/delete "><i class="fa fa-close"></i></a>
    <a style="text-decoration:none;" href="/User/{{$user->id}}/editable "><i class="fa fa-edit"></i></a></td> 
    @endforeach
  </tr>
</table>
@endsection