...
<table>
  ...
  @foreach ($groups as $group)
    ...
    <td>{{ $group->id }}</td>
    <td>{{ $group->name }}</td>
    <td><a style="text-decoration:none;" href="/Groupdoc/{{$group->id}}/delete "><i class="fa fa-close"></i></a>
    <a style="text-decoration:none;" href="/Groupdoc/{{$group->id}}/editable "><i class="fa fa-edit"></i></a></td> 
    @endforeach
  </tr>
</table>
@endsection